...
assert.equal(pkg.version,'0.17.14','release candidate must use 0.17.14 package version');
assert.match(data,/appVersion:\s*'0\.17\.14'/,'visible planner version must match package version');
