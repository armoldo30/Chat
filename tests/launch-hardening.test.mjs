...
assert.equal(pkg.version,'0.17.3','release candidate must use 0.17.3 package version');
assert.match(data,/appVersion:\s*'0\.17\.3'/,'visible planner version must match package version');
