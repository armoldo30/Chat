...
assert.match(workflow,/\.app-shell\s*\{[^}]*padding-bottom:calc\(var\(--mobile-tool-dock-height\) \+ env\(safe-area-inset-bottom\)\)!important;/s,'planner content must reserve space for the bottom dock and safe area');
