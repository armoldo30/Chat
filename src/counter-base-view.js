...
export function renderCounterBase(host){
  ...
  host.innerHTML=`<section class="counter-hero"><div><p class="eyebrow">POST-GAME MATCHUP REVIEW</p><h2>Counter Analysis</h2><p>Recreate the division that gave you trouble, then test focused one- and two-change counters against that exact target. Recommendations explain the modeled combat mechanism and compare the improvement against equipment cost.</p></div><button class="primary" id="runCounterSearch">FIND COUNTERS</button></section>
