...
import { AD_CONFIG, adsReady, validAdSenseClient } from '../src/ad-config.js';
...
const servingScript=configuredClient&&adsReady()?`<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=${configuredClient}" crossorigin="anonymous"></script>`:'';
html=html.replace('<!-- ADSENSE_ACCOUNT_META -->',[accountMeta,servingScript].filter(Boolean).join('\n  '));
