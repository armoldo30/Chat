...
assert.equal(pkg.version,'0.17.13','release candidate must use 0.17.13 package version');
assert.match(data,/appVersion:\s*'0\.17\.13'/,'visible planner version must match package version');
