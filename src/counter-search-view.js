...
function noCounterPanel(search,snap,config,side){
  ...
  if(!deep&&base<35)diagnosis='This matchup is heavily unfavorable. The normal one/two-change search did not find a meaningful local counter; the optional deep redesign can test a bounded third change before concluding that a broader rebuild is needed.';
