...
assert.equal(pkg.version,'0.17.15','release candidate must use 0.17.15 package version');
assert.match(data,/appVersion:\s*'0\.17\.15'/,'visible planner version must match package version');
