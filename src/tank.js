...
function packDefaults(family,chassisId,role='armor'){
  ...
  const suspension=firstFromSet(compatibleIds(TANK_SUSPENSIONS,ch,'suspension_type_slot',[],role),['tank_bogie_suspension','tank_torsion_bar_suspension','tank_christie_suspension','tank_interleaved_suspension']);
