...
assert.equal(summary.records,112,'actionable 1.19.2 doctrine catalog must be 9 grand + 14 track + 89 subdoctrine records');
...
assert.equal(rewards,444);
assert.equal(milestones,32);
