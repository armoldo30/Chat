...
assert.equal(pkg.version,'0.17.12','release candidate must use 0.17.12 package version');
assert.match(data,/appVersion:\s*'0\.17\.12'/,'visible planner version must match package version');
