...
assert.equal(pkg.version,'0.17.4','release candidate must use 0.17.4 package version');
assert.match(data,/appVersion:\s*'0\.17\.4'/,'visible planner version must match package version');
