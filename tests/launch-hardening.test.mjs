...
assert.equal(pkg.version,'0.17.10','release candidate must use 0.17.10 package version');
assert.match(data,/appVersion:\s*'0\.17\.10'/,'visible planner version must match package version');
