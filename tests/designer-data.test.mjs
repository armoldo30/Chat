...
const pack={equipment:{
  ...
  small_plane_airframe_1:{id:'small_plane_airframe_1',year:1940,cost:15,reliability:.8,airDefense:5,airAgility:60,airRange:700,speed:400,moduleSlots:{fixed_engine:{allowed_module_categories:['plane_engine_type']}},raw:{}}
},modules:{
  ...
  heavy_machine_gun_2x:{id:'heavy_machine_gun_2x',category:'plane_weapon',addStats:{air_attack:10,build_cost_ic:2},multiplyStats:{air_agility:-.05},addAverageStats:{},resources:{},raw:{}},
  armor_plates:{id:'armor_plates',category:'plane_special_module_defense',addStats:{air_defence:5,build_cost_ic:2},multiplyStats:{},addAverageStats:{},resources:{},raw:{}},
  drop_tanks:{id:'drop_tanks',category:'plane_special_module',addStats:{air_range:250,build_cost_ic:1},multiplyStats:{},addAverageStats:{},resources:{},raw:{}}
}};
...
assert.ok(air.specials.drop_tanks);
