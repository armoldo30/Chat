...
import { REGIMENTAL_SUPPORT_COMPATIBILITY_1192, REGIMENTAL_SUPPORT_COMPATIBILITY_META, applyRegimentalSupportCompatibilityFallback, regimentalSupportAllowed, supportAllowedBattalionGroups } from '../src/regimental-support-1192.js';
...
for(const id of Object.keys(REGIMENTAL_SUPPORT_COMPATIBILITY_1192))assert.ok(ids.includes(id),`bundled regimental support ${id} should exist in the 1.19.2 pack`);
...
console.log('Regimental support structural regression checks passed.');
