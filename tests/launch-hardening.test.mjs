...
assert.equal(pkg.version,'0.17.5','release candidate must use 0.17.5 package version');
assert.match(data,/appVersion:\s*'0\.17\.5'/,'visible planner version must match package version');
