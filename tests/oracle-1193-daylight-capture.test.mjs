...
const text=readFileSync(new URL('../oracle-lab/captures/o1-1193-daylight-001-wpo1.log.txt',import.meta.url),'utf8');
...
assert.equal(run.summary.deltas.attackerOrgLoss,0.2385);
assert.equal(run.summary.deltas.attackerStrengthLoss,0.049);
assert.equal(run.summary.deltas.defenderOrgLoss,0.7395);
assert.equal(run.summary.deltas.defenderStrengthLoss,0.1345);

console.log('Oracle 1.19.3 daylight smoke capture regression passed.');
