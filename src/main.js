...
function ensureDesignerState(side){
  ...
  state[side+'Supports']=(Array.isArray(state[side+'Supports'])?state[side+'Supports']:[]).filter(x=>supports[x]&&BASE_DIVISIONAL_SUPPORTS.includes(x)).slice(0,5);
