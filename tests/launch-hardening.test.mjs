...
assert.equal(pkg.version,'0.17.11','release candidate must use 0.17.11 package version');
assert.match(data,/appVersion:\s*'0\.17\.11'/,'visible planner version must match package version');
