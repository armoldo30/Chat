...
assert.equal(pack.meta.executableValidation,'core-ordinary-unarmored-oracle-validated');
assert.equal(pack.meta.executableEvidenceBase,'mixed-1.19.3-oracle-validated-and-bounded-inference');
assert.equal(pack.meta.oracleCombatCertification.evidence.combinedTransport.classification,'oracle-validated');
